  ...
  return (
    <>
      ...
      <div className={styles.header}>
        ...
        <a href='https://opensea.io/collection/hunnys' rel="noreferrer" target='_blank'>
        <svg
          width={30}
          height={30}
          ...
          <path xmlns="http://www.w3.org/2000/svg" d="M90 45C90 69.8514 69.8514 90 45 90C20.1486 90 0 69.8514 0 45C0 20.1486 20.1486 0 45 0C69.8566 0 90 20.1486 90 45Z" fill="#2081E2"/>
